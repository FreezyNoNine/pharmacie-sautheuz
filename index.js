...
const logo = '/image/ps_logo.png';
const account = '/image/account.png';
const panier = '/image/panier.png';
const mewing = '/image/mewing.gif';
const montana = '/image/empereur.jpg';
const drugs = '/image/drugs.png';
const senzu = '/image/senzu.png';
...
app.locals.panier = panier;
app.locals.mewing = mewing;
app.locals.montana = montana;
app.locals.drugs = drugs;
app.locals.senzu = senzu;
